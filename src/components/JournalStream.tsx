...
export function JournalStream({ posts }: JournalStreamProps) {
  ...
  return (
    ...
    // with h-28 and covers y 24..136px, so an anchor jump to #stream would land
    // the heading underneath it. Same collision as #skies, swept here.
    <section id="stream" className="relative py-24 overflow-hidden scroll-mt-40 sm:scroll-mt-32">
      {/* Background */}
